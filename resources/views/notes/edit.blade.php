@extends("layouts.app")
@section('page-title','Edit Patient Visit Details')
            ...
            <div class="tab-content card-block">
                ...
                <div class="tab-pane active" id="note" role="tabpanel" aria-expanded="true">
                    ...
                    <div class="container-fluid">
                        <form id="ajax-note" action="{{ route('notes.update', [$visit->id,$note->id]) }}" method="post"
                        >
                            @csrf
                            @method('patch')
                            {{--	Complaints	--}}
                                ...
                                <div class="card-block collapse show form-material" id="Complaints">
                                    <div class="form-group form-default">
                                        <textarea class="form-control"
                                                  name="chief_complaints">{!! $note->chief_complaints !!}</textarea>
                                        <span class="form-bar"></span>
                                        <label class="float-label">Chief Complaints</label>
                                    </div>
                                    <div class="form-group form-default">
                                        <textarea class="form-control" name="hpi">{!! $note->hpi !!}</textarea>
                                        <span class="form-bar"></span>
                            ...
                            <div class="card">
                                ...
                                <div class="card-block collapse form-material" id="assessments">
                                    ...
                                    <div class="form-group" style="z-index: 7">
                                        ...
                                        <button type="button" id="mark-disposition"
                                                class="btn btn-info btn-round btn-sm">Check
                                        </button>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="form-group d-flex flex-column">
                                        @foreach($dispositions as $disposition)
                                            ...
                                            <div class="checkbox-fade fade-in-primary d-">
                                                <label>
                                                    <input type="checkbox" name="diagnoses[]"
                                                           id="checkBox-{{$disposition->id}}"
                                                           value="{{$disposition->diagnosis}}" data-toggle="collapse"
                                                           href="#diagnosis-{{$disposition->id}}"
                                                           aria-controls="diagnosis-{{$disposition->id}}"

                                                    @foreach($patient_dispositions as $PD)
                                                        {{ $disposition->diagnosis == $PD->diagnosis ? 'checked' : ""}}
                                                    @endforeach
                                                    >
                                                    <span class="cr">
                                    ...
                                    @foreach($dispositions as $disposition)
                                        ...
                                        <div class="collapse
                                        @foreach($patient_dispositions as $PD)
                                        {{ $disposition->diagnosis == $PD->diagnosis ? 'show' : ""}}
                                        @endforeach
                                        " id="diagnosis-{{$disposition->id}}">
                                            ...
                                            <div class="card" id="{{$disposition->spaceLessName}}">
                                                <div class="card-block">
                                                    ...
                                                    <textarea name="dispositions[{{$disposition->diagnosis}}]"
                                                              class="editor">
                                                         @foreach($patient_dispositions as $PD)
                                                            {{ $disposition->diagnosis == $PD->diagnosis ? $PD->disposition : $disposition->disposition}}
                                                        @endforeach
                                                    </textarea>
                                                </div>
                                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-block collapse form-material" id="Treatment">
                                    ...
                                    <div class="form-group form-default">
                                        <textarea class="form-control" name="treatment">{!! $note->treatment !!}</textarea>
                                        <span class="form-bar"></span>
                                        <label class="float-label">Treatment</label>
                                    </div>
                                    <div class="form-group form-default">
                                        <textarea class="form-control" name="prescribed_medicine">{!! $note->prescribed_medicine !!}</textarea>
                                        <span class="form-bar"></span>
                            ...
                            <div class="card">
                                ...
                                <div class="card-block collapse form-material" id="Care-plan">
                                    <div class="form-group form-default">
                                        <textarea class="form-control" name="care_plan">{!! $note->care_plan !!}</textarea>
                                        <span class="form-bar"></span>
                ...
                <div class="tab-pane" id="reviews" role="tabpanel" aria-expanded="true">
                    <div class="col-md-11 mx-auto">
                        <form class="form-material" id="ajax-form"
                            ...
                            @foreach($patient_reviews as $ros)
                                <div class="card">
                                    <div class="card-header">
                                        <h5>{{$ros['name']}}</h5>
                                    </div>
